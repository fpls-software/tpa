	...
	<div class="box">
		<div class="box-inner">
			<div class="box-header well">
				<h2>Data Peserta Didik di TPA <?php echo $loaddata['nm_lembaga']; ?> </h2>
			</div>
			<div class="box-content">
				...
				<?php
					...
					echo form_open('admin/updatepd', $form_attribute);
				?>
				<div class="row">
					<div class="col-lg-6">
						<div class="box">
				...
				<button type="submit" class="btn btn-primary"> Update Peserta Didik</button>
				<?php 
					echo form_close();
				?>
			</div>
