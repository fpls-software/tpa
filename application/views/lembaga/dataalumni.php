<?php foreach($dataalumni as $loaddata) {}  ?>
	...
	<div class="box">
		<div class="box-inner">
			...
			<div class="box-content">
				<a href="<?php echo base_url("index.php/lembaga/tambahalumni/")?>"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> Tambah Data Alumni</button></a>
				<hr/>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><a href="<?php echo base_url("index.php/lembaga/editalumni/").$loaddata['no_induk']; ?>"><button type="button" class="btn btn-success btn-flat"><span class="glyphicon glyphicon-edit"></span> Edit</button></a></td>
								<td><a href="<?php echo base_url("index.php/lembaga/hapusalumni/").$loaddata['no_induk']; ?>"><button type="button" class="btn btn-danger btn-flat"><span class="glyphicon glyphicon-remove"></span> Hapus</button></a></td>
							</tr>
						<?php 
							} 
						?>
